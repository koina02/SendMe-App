    ...
    >
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        <Image
          ...
          priority
        />
        <ol className="list-inside list-decimal text-sm text-center sm:text-left" style={{ fontFamily: "var(--font-roboto-mono)" }}>
          <li className="mb-2 tracking-tight">
            Get started by editing{" "}
            <code className="bg-black/[0.05] dark:bg-white/[0.06] px-1 py-0.5 rounded font-semibold">
              src/pages/index.tsx
            </code>
            .
          </li>
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            className="rounded-full border border-black/[0.08] dark:border-white/[0.145] transition-colors flex items-center justify-center hover:bg-[#f2f2f2] dark:hover:bg-[#1a1a1a] hover:border-transparent font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[158px]"
